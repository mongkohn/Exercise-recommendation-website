  ...
  return (
    <div>
      ...
      <ul className="text-sm space-y-1">
        ...
        <li>
          <a href="mailto:mongkohn.kubpom@gmail.com" className="text-blue-300 hover:underline hover:text-blue-500">
            mongkohn.kubpom@gmail.com
          </a>
        </li>
        <li>
          <a href="mailto:okm6344@gmail.com" className="text-blue-300 hover:underline hover:text-blue-500">
            okm6344@gmail.com
          </a>
        </li>
      </ul>
      <ul>
        ...
        <li>
          <a href="tel:0926241304" className="text-sm text-blue-300 hover:underline hover:text-blue-500">
            092-624-1304
          </a>
        </li>
        <li>
          <a href="tel:0927511329" className="text-sm text-blue-300 hover:underline hover:text-blue-500">
            092-751-1329
          </a>
        </li>
      </ul>
